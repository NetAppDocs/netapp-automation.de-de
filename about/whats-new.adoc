...
Der https://console.netapp.com/automationHub["NetApp Console Automatisierungszentrale"^] ist über die Webbenutzeroberfläche der Konsole verfügbar. Der Automatisierungs-Hub bietet Zugriff auf Lösungen, die Sie bei der automatisierten Bereitstellung und Integration von NetApp -Produkten unterstützen. Die Dokumentation für diese Lösungen ist in verschiedene Produkt- oder Funktionsbereiche unterteilt, wie nachfolgend beschrieben.
