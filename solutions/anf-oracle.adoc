...
* Sie müssen die https://console.netapp.com/automationHub["Oracle mit Azure NetApp Files"^] Automatisierungslösung über die NetApp Console Web-Benutzeroberfläche. Die Lösung ist als Datei verpackt. `na_oracle19c_deploy-master.zip`Die
