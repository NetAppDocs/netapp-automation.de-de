...
* Sie müssen die https://console.netapp.com/automationHub["Amazon FSx for NetApp ONTAP Management – ​​Burst to Cloud"^] Automatisierungslösung über die NetApp Console Web-Benutzeroberfläche. Die Lösung ist als Datei verpackt. `AWS_FSxN_BTC.zip`Die
