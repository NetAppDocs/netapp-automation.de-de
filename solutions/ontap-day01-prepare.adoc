...
. Laden Sie die link:https://console.netapp.com/automationHub["ONTAP - Tag 0/1  Health Checks"^] Automatisierungslösung über die Web-Benutzeroberfläche der Konsole. Die Lösung ist verpackt als `ONTAP_DAY0_DAY1.zip`Die
